...
Once you have uploaded your data, you can use the LLM Engine API to launch a fine-tune with [FineTune.Create](../../api/python_client/#llmengine.fine_tuning.FineTune.create) API. You will need to specify which base model to fine-tune, the locations of the training file and optional validation data file, an optional set of hyperparameters to customize the fine-tuning behavior, and an optional suffix to append to the name of the fine-tune.
